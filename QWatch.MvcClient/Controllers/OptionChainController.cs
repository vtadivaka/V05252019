...
namespace MvcClient.Controllers
{
    public class OptionChainController : Controller
    {
        ...
        private List<OptionChain> LoadOptionsFullData(string masterFilePath)
        {
            ...
            {
                optionsData.AddRange((List<OptionChain>)xmltoObj.CreateOptionsObject(optionsData, currentFile, false));
            }
            return optionsData;
        }
